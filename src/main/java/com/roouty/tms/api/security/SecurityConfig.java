...
import com.roouty.tms.api.entity.RoleEnum;
import com.roouty.tms.api.security.UNUSED.ApiAccessDeniedHandler;
import com.roouty.tms.api.security.UNUSED.ApiAuthenticationEntryPoint;
import com.roouty.tms.api.security.UNUSED.FilterChainFailureHandler;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
  ...
  protected void configure(HttpSecurity http) throws Exception {
    http.httpBasic().disable().formLogin().disable()
        ...
        .and()
        .authorizeRequests()
        .antMatchers(HttpMethod.POST, Constants.TOKEN_URL).permitAll()
        .antMatchers(HttpMethod.DELETE, Constants.TOKEN_URL).permitAll()
        ...
        .antMatchers(Constants.ACTUATOR_URL_PREFIX).permitAll()
